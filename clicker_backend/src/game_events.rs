...
pub enum ServerMessages {
    ...
    LoginState { shovel_amount: i32, shovel_depth: i32, automation_depth: i32, automation_amount: i32, attack_level: i32, defence_level: i32, automation_started: bool, image_data: [u8] },
